defmodule WorkspaceWeb.UserAuth do
  ...
  defp signed_in_path(_conn), do: ~p"/inbox"

  @doc """
  Google OAuth redirect URI.
  """
  def google_oauth_redirect_uri, do: Application.fetch_env!(:nomdoc, WorkspaceWeb.UserAuth)[:google_oauth_redirect_uri]
end

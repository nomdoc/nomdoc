defmodule HealthcareWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: HealthcareWeb.Layouts]
  ...
  def live_view(opts \\ []) do
    quote do
      @opts Keyword.merge(
              [
                layout: {HealthcareWeb.Layouts, :app},
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: HealthcareWeb.Router,
        statics: HealthcareWeb.static_paths()
    end
  end

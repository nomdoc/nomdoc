defmodule NomdocWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    signing_salt: "Rwk9knWk3GU5zIA28aQ4kkcT8WUuT6D6DsFkkg55uhbtDtezq/GE0/XG3jACOp2k",
    key: "__Host-SESSION",
    path: "/",
    http_only: true,
    secure: true,

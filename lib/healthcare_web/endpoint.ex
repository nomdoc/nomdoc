defmodule HealthcareWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    signing_salt: "6hOl9HGi75vnP0TnXFI5X7cbjuRkhjFZkHhS3gZAXB2Z2T/EFwQsEiUV7cfRuxaH",
    key: "__Host-SESSION",
    path: "/",
    http_only: true,
    secure: true,
  ...
  plug Plug.Static,
    ...
    from: :nomdoc,
    gzip: false,
    only: HealthcareWeb.static_paths()
  ...
  plug Phoenix.LiveDashboard.RequestLogger,
    param_key: "healthcare_request_logger",
    cookie_key: "healthcare_request_logger"

defmodule HealthcareWeb.UserAuth do
  @moduledoc false

  use HealthcareWeb, :verified_routes
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      HealthcareWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  """
  def google_oauth_redirect_uri, do: Application.fetch_env!(:nomdoc, HealthcareWeb.UserAuth)[:google_oauth_redirect_uri]
end

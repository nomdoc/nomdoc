defmodule ConsoleWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    signing_salt: "lt2oeXm4FDCyodFi7oXN9Ml3MvmevNFv04R7613UB4Ssb/Od63PDjX4hWrFFsG7C",
    key: "__Host-SESSION",
    path: "/",
    http_only: true,
    secure: true,
  ...
  plug Phoenix.LiveDashboard.RequestLogger,
    param_key: "console_request_logger",
    cookie_key: "console_request_logger"
